...
exports.createLambdaSQSRole = function(appName) {
  const role = new aws.iam.Role(`${appName}-role-lambdaSQS`, {
    assumeRolePolicy: {
      Version: "2012-10-17",
      Statement: [{
          Action: "sts:AssumeRole",
  ...
  new aws.iam.RolePolicyAttachment(`${appName}-attach-lambda`, {
    role: role,
    policyArn: aws.iam.ManagedPolicies.AWSLambdaFullAccess,
  });
  new aws.iam.RolePolicyAttachment(`${appName}-attach-sqs`, {
    role: role,
