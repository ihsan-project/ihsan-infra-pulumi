...
exports.createECS = function(security, db, roles) {
    ...
    const httpTarget = alb.createTargetGroup("http-target", { port: 80, protocol: "HTTP", targetType: "instance" });
    // const listener = httpTarget.createListener("https-listener", {
    //     port: 443,
    //     certificateArn: sslCert.arn,
    //     protocol: "HTTPS",
    // });
    const listener = httpTarget.createListener("http-listener", {
        port: 80,
        protocol: "HTTP",
    });
    ...
    const service = new awsx.ecs.EC2Service("api-service", {
        ...
        // securityGroups: [ appSg ],
        // subnets: [ vpc.prviateSubnets ],
        // loadBalancers: [{
        //     containerName: "khatm_container",
        //     containerPort: 80,
        //     elbName: alb.name
        // }],
        taskDefinitionArgs: {
