...
exports.createECS = function(appName, security, db, roles) {
    ...
    const httpTarget = alb.createTargetGroup(`${appName}-alb-trgt`, {
        port: 80,
        protocol: "HTTP",
        targetType: "instance",
        healthCheck: {
    ...
    const listener = httpTarget.createListener(`${appName}-alb-lstnr`, {
        port: 443,
