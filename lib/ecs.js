...
const createALB = function(appName, environment) {
    ...
    const albTarget = alb.createTargetGroup(`${appName}-alb-trgt`, {
        ...
        healthCheck: {
            ...
            path: process.env.HEALTH_CHECK_URL,
...
exports.createECS = function(appName, environment, db, containerName, pushQueue) {
        ...
        taskDefinitionArgs: {
            ...
            containers: {
                [containerName]: {
                    ...
                    }], // TODO: Need to add AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY and AWS_REGION for push SQS
                    environment: [{
